...
Original file is located at
    https://colab.research.google.com/drive/10wUPNcw06LWp1CbRglFcryGnQFkmX9lj

# Lesson20の課題用: 図書管理システムのコード

以下のコードをVSCode上のファイルにコピーし、「Lesson20: GitHub Copilot」の提出課題に取り組んでください。
"""
